 ...
 *
 */
public class RestBadReqeustException extends RuntimeException {
	 ...
	 */
	public RestBadReqeustException() {
		super();
	}
	 ...
	 *            {@code Throwable.getMessage}
	 */
	public RestBadReqeustException(String message) {
		super(message);
	}
	 ...
	 */
	public RestBadReqeustException(Throwable cause) {
		super(cause);
	}
	 ...
	 *            {@code Throwable.getCause}
	 */
	public RestBadReqeustException(String message, Throwable cause) {
		super(message, cause);
	}
